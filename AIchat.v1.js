...
(function($) {
    $.widget("ui.chatbox", {
      ...
      else{  uiChatboxRest = (self.uiChatboxRest = $('<div><ul>	<li>		<a href="#">Related Answers</a>	<ul id="respuestarel">		</ul>		</li>		<li>Answer not found? please drop us a message at "Contact Us" section of this website.</li></ul></div>'))
                .addClass('ui-widget-content ' +
                          'ui-chatbox-rest ' 
                         )
                .appendTo(uiChatboxContent);}
